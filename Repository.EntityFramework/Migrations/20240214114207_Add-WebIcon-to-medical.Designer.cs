...
namespace Repository.EntityFramework.Migrations
{
    ...
    [Migration("20240214114207_Add-WebIcon-to-medical")]
    partial class AddWebIcontomedical
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.Benefit", b =>
                {
                    ...
                    b.Property<string>("ArabicDateToMatch")
                    ...
                    b.Property<string>("ArabicRequiredDocuments")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("CertainDate")
                    ...
                    b.Property<bool>("HasChilderen")
                        .HasColumnType("bit");

                    b.Property<bool>("HasMails")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.BenefitMail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.EmailLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("MedicalSubCategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("WorkingHours_AR")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WorkingHours_EN")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalSubCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("MedicalCategoryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MobileVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.RequestDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.RequestWorkflow", b =>
                {
                    ...
                    b.HasIndex("WhoResponseId");

                    b.ToTable("RequestWorkflows");
                });

            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.UserNotification", b =>
                {
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.Violation", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalDetails", b =>
                {
                    b.HasOne("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalSubCategory", "MedicalSubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalSubCategory", b =>
                {
                    b.HasOne("MoreForYou.Models.Models.MasterModels.MedicalModels.MedicalCategory", "MedicalCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.RequestWorkflow", b =>
                {
                    ...
                    b.HasOne("MoreForYou.Models.Models.MasterModels.Employee", "WhoResponse")
                        .WithMany()
                        .HasForeignKey("WhoResponseId");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.UserNotification", b =>
                {
                    ...
                    b.HasOne("MoreForYou.Models.Models.MasterModels.Notification", "Notification")
                        .WithMany()
